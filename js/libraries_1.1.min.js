...
function generateFlatIconFromImage(e){loadToCanvas(e,function(e){lastCroppedIconCanvas=cropVisibleImageToNewCanvas(e);var a=lastCroppedIconCanvas.width*padding+lastCroppedIconCanvas.width,n=lastCroppedIconCanvas.height*padding+lastCroppedIconCanvas.height,t=diameterForDimensions(a,n);lastIconBackground=createIconBackground(t),lastPaddedIconCanvas=centerCanvas(lastCroppedIconCanvas,t,t),lastUnmergedIconCanvas=drawShadow(lastPaddedIconCanvas),lastMergedIconCanvas=mergeIconWithBackground(lastUnmergedIconCanvas,lastIconBackground),updatePreview(),downloadDisabled&&(downloadButton.classList.remove("disabled"),downloadDisabled=!1)})}function updateCurrentPadding(){if(padding=paddingPicker.value,null!=lastCroppedIconCanvas){var e=lastCroppedIconCanvas.width*padding+lastCroppedIconCanvas.width,a=lastCroppedIconCanvas.height*padding+lastCroppedIconCanvas.height,n=diameterForDimensions(e,a);lastIconBackground=createIconBackground(n),lastPaddedIconCanvas=centerCanvas(lastCroppedIconCanvas,n,n),lastUnmergedIconCanvas=drawShadow(lastPaddedIconCanvas),lastMergedIconCanvas=mergeIconWithBackground(lastUnmergedIconCanvas,lastIconBackground),updatePreview()}}function updateCurrentShadow(){shadowAngle=anglePicker.value,shadowOpacity=opacityPicker.value,shadowLength=lengthPicker.value,null!=lastPaddedIconCanvas&&(lastUnmergedIconCanvas=drawShadow(lastPaddedIconCanvas),lastMergedIconCanvas=mergeIconWithBackground(lastUnmergedIconCanvas,lastIconBackground),updatePreview())}function updateCurrentBackground(){null!=lastUnmergedIconCanvas&&(lastIconBackground=createIconBackground(lastIconBackground.width),lastMergedIconCanvas=mergeIconWithBackground(lastUnmergedIconCanvas,lastIconBackground),updatePreview())}function updatePreview(){previewContext.setTransform(1,0,0,1,0,0),previewContext.clearRect(0,0,previewCanvas.width,previewCanvas.height);var e=previewCanvas.width/lastMergedIconCanvas.width;previewContext.scale(e,e),previewContext.drawImage(lastMergedIconCanvas,0,0)}function downloadIcon(e){downloadDisabled||(e.href=lastMergedIconCanvas.toDataURL(),e.download="icon.png")}function loadToCanvas(e,a){var n=new Image;n.onload=function(){a(n)},n.src=e}function cropVisibleImageToNewCanvas(e){var a=document.createElement("canvas"),n=a.getContext("2d");a.width=e.width,a.height=e.height,n.drawImage(e,0,0);for(var t=e.width,o=e.height,d=a.getContext("2d").getImageData(0,0,t,o),r=d.data,c=t,i=o,l=0,s=0,g=0;o>g;g++)for(var u=0;t>u;u++){var v=r[4*(t*g+u)+3];v>0&&(c>u&&(c=u),u>l&&(l=u),i>g&&(i=g),g>s&&(s=g))}var p=l-c+1,h=s-i+1,C=document.createElement("canvas");return C.width=p,C.height=h,C.getContext("2d").drawImage(e,c,i,p,h,0,0,p,h),C}function createIconBackground(e){var a=document.createElement("canvas");a.width=e,a.height=e;var n=a.getContext("2d");return n.fillStyle=iconBackground,"circle"==shapePicker.value?(n.arc(e/2,e/2,e/2,0,2*Math.PI),n.fill()):n.fillRect(0,0,e,e),a}function centerCanvas(e,a,n){var t=document.createElement("canvas");t.width=a,t.height=n;var o=.5*(a-e.width),d=.5*(n-e.height);return t.getContext("2d").drawImage(e,o,d),t}function drawShadow(e){var a=e.width,n=e.getContext("2d"),t=document.createElement("canvas"),o=t.getContext("2d");t.width=a,t.height=a;var d=.0174532925,r=Math.tan(shadowAngle*d);o.imageSmoothingEnabled=!0;for(var c=0;a/2*shadowLength>c;c++){o.drawImage(e,c,r*c);var i=(c-1)*r;if(r*c>1)for(;c*r>i&&a>i;)o.drawImage(e,c,i),i++}for(var l=o.getImageData(0,0,a,a),s=l.data,g=n.getImageData(0,0,a,a),u=g.data,c=0,v=s.length;v>c;c+=4)s[c]=u[c],s[c+1]=u[c+1],s[c+2]=u[c+2],s[c+3]=u[c+3]+shadowOpacity*s[c+3];return o.putImageData(l,0,0),o.drawImage(e,0,0),t}function mergeIconWithBackground(e,a){for(var n=e.width,t=e.getContext("2d"),o=t.getImageData(0,0,n,n),d=o.data,r=a.getContext("2d"),c=r.getImageData(0,0,n,n),i=c.data,l=0,s=i.length;s>l;l+=4){var g=d[l+3]/255,u=i[l+3]/255;u>0&&g>0&&(1==g&&1==u?(i[l]=d[l],i[l+1]=d[l+1],i[l+2]=d[l+2],i[l+3]=d[l+3]):(i[l]=d[l]+(1-g)*i[l],i[l+1]=d[l+1]+(1-g)*i[l+1],i[l+2]=d[l+2]+(1-g)*i[l+2],i[l+3]=d[l+3]+(1-g)*i[l+3]))}var v=document.createElement("canvas");return v.width=n,v.height=n,v.getContext("2d").putImageData(c,0,0),v}function diameterForDimensions(e,a){return Math.sqrt(e*e+a*a)}function handleFileSelect(e){handleDragExit(e),e.stopPropagation(),e.preventDefault();for(var a,n=e.dataTransfer?e.dataTransfer.files:e.target.files,t=0;a=n[t];t++)if(a.type.match("image.*")){var o=new FileReader;o.onload=function(e){return function(e){generateFlatIconFromImage(e.target.result)}}(a),o.readAsDataURL(a)}}function handleDragEnter(e){cancelEvent(e),counter++,document.getElementById("drop_zone").classList.add("dropping")}function handleDragExit(e){cancelEvent(e),counter--,0===counter&&document.getElementById("drop_zone").classList.remove("dropping")}function cancelEvent(e){e.preventDefault()}function triggerFileUpload(){document.getElementById("files").click()}function initControls(){$(colorPicker).colpick({color:iconBackground,layout:"hex",submit:0,colorScheme:"dark",onChange:function(e,a,n,t,o){$(t).css("border-color","#"+a),iconBackground="#"+a,updateCurrentBackground(),o||$(t).val(a)}}).keyup(function(){$(this).colpickSetColor(this.value)}),$(opacityPicker).rangeslider({polyfill:!1,onSlide:function(e,a){updateCurrentShadow()}}),$(lengthPicker).rangeslider({polyfill:!1,onSlide:function(e,a){updateCurrentShadow()}}),$(anglePicker).rangeslider({polyfill:!1,onSlide:function(e,a){updateCurrentShadow()}}),$(paddingPicker).rangeslider({polyfill:!1,onSlide:function(e,a){updateCurrentPadding()}}),shapePicker.onchange=function(){updateCurrentBackground()}}function setupPlaceholder(){previewContext.fillStyle="rgb(200, 200, 200)",previewContext.fillRect(0,0,previewCanvas.width,previewCanvas.height),previewContext.fillStyle="rgb(150, 150, 150)",previewContext.font="16px Helvetica",previewContext.fillText("PREVIEW",120,150)}function setupIconLibrarySelectionListener(){$("li[class^=ion]").click(function(e){var a=e.target,n=a.classList[0].slice(4);$("#IconLibraryModal").modal("hide"),generateFlatIconFromImage("/img/ionicons/512/"+n+".png")})}function setupFileListener(){var e=document.getElementById("drop_zone");e.addEventListener("dragover",cancelEvent,!1),e.addEventListener("dragenter",handleDragEnter,!1),e.addEventListener("dragleave",handleDragExit,!1),e.addEventListener("drop",handleFileSelect,!1),document.getElementById("files").addEventListener("change",handleFileSelect,!1)}var previewCanvas=document.getElementById("canvas"),previewContext=canvas.getContext("2d"),downloadButton=document.getElementById("download"),colorPicker=document.getElementById("colorPicker"),shapePicker=document.getElementById("shapePicker"),paddingPicker=document.getElementById("paddingPicker"),anglePicker=document.getElementById("anglePicker"),opacityPicker=document.getElementById("opacityPicker"),lengthPicker=document.getElementById("lengthPicker"),downloadDisabled=!0,iconBackground="hsl(168, 76%, 42%)",shadowOpacity=.3,shadowLength=1,shadowAngle=45,padding=0,lastCroppedIconCanvas,lastPaddedIconCanvas,lastUnmergedIconCanvas,lastIconBackground,lastMergedIconCanvas,counter=0;window.addEventListener("load",function(){initControls(),setupPlaceholder(),setupFileListener(),setupIconLibrarySelectionListener()});